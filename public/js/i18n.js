...
const I18N = {
  en: {
    ...
    account_type_label: 'I want to',
    account_type_buyer: 'Buy wholesale',
    account_type_seller: 'Sell my products',
    ...
    my_products_subtitle: 'Add, edit, and manage the products your storefront sells.',
    ...
    moq_label_field: 'MOQ (min order qty)',
    stock_qty_label: 'Stock Quantity',
    image_url_label: 'Image URL',
    save_btn: 'Save',
    cancel_btn: 'Cancel',
    active_label: 'Active (visible in catalog)',
    edit_btn: 'Edit',
    deactivate_btn: 'Deactivate',
    reactivate_btn: 'Reactivate',
    no_products_yet: 'You have not added any products yet.',
    pricing_tiers_label: 'Bulk pricing tiers',
    add_tier_btn: 'Add tier',
    tier_min_qty_placeholder: 'Min qty',
    tier_unit_price_placeholder: 'Unit price',
    remove_tier_btn: 'Remove',
    seller_account_pending: 'Your seller account is pending admin approval. Once approved, you can log in and start listing products.',
    please_log_in_seller: 'Please log in with a seller or admin account to manage products.',
